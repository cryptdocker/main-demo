		...
		<Section
			...
			<div className="mt-4 rounded-2xl border border-white/10 bg-dark-card/40 p-4">
					...
					<label className="space-y-1">
						...
						<input
							...
							className={cx(
								...
								(topUp.busy || !!topUp.payment) && "opacity-60 cursor-not-allowed",
							)}
							placeholder="10"
						/>
				...
				<div className="mt-3 flex flex-wrap items-center gap-2">
					<Button size="sm" onClick={topUp.onPay} disabled={topUp.busy || !!topUp.payment}>
						...
						{topUp.payment ? (
							...
							<div className="rounded-lg border border-white/10 bg-white/3 px-3 py-2">
								...
								<p className="mt-1 text-xs text-slate-600 leading-relaxed">
									Choose a method and amount, then create a payment. Your deposit
									address, QR code, and live status will appear here.
								</p>
							</div>
						)}
					</div>
